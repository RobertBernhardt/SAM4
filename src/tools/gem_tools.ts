 ...
 */
function searchGems_(type: string, query: string): GemResult[] {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        if (rowType !== type.toLowerCase()) continue;
...
const SEARCH_IMAGE_GEMS_DECLARATION: GeminiFunctionDeclaration = {
    name: 'searchImageGems',
    description:
        'Searches the Gems database for image-type gems matching a query. ' +
...
const SEARCH_CONTENT_GEMS_DECLARATION: GeminiFunctionDeclaration = {
    name: 'searchContentGems',
    description:
        'Searches the Gems database for content-type gems matching a query. ' +
...
const SEARCH_INTERACTIVE_GEMS_DECLARATION: GeminiFunctionDeclaration = {
    name: 'searchInteractiveGems',
    description:
        'Searches the Gems database for interactive-type gems matching a query. ' +
