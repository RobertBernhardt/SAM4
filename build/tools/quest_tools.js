 ...
 */
function executeSuggestSubquest(args) {
    if (!args.parent_quest_id || !args.suggested_subquest_id || !args.suggested_weight || !args.description) {
        return { error: "Missing required parameters." };
    }
    try {
        const result = suggestSubquest(args.parent_quest_id, args.suggested_subquest_id, args.suggested_weight, args.description);
